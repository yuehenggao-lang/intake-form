...
const DEMO = {
  ...
  familyName: 'LIU', givenName: 'ZHIQIANG',
  aliasInd: 'Y', aliasFamily: 'LIU', aliasGiven: 'JIANQIANG',
  sex: 'Male', dob: '1977-04-25', birthCity: 'Dalian', birthCountry: '202', citizenship: '202',
  ...
  passportNum: 'EG5566778', passportCountry: '202',
  passportIssue: '2020-06-30', passportExpiry: '2030-06-29',
  nativeLang: '299', ableTo: 'English', langTest: 'Y',
  natIdInd: 'Y', natIdNum: '210204197704250037', natIdCountry: '202',
  natIdIssue: '2014-08-15', natIdExpiry: '2034-08-15', usCardInd: 'N',
  ...
  motherName: 'ZHAO, Shuqin', motherZh: '赵淑琴', motherDOB: '1952-01-08', motherCOB: 'China',
  motherMStatus: '7', motherAddress: 'Zhongshan District, Dalian, Liaoning',
  motherOccupation: 'Retired', motherAcc: 'N',
  fatherName: 'LIU, Zhenhua', fatherZh: '刘振华', fatherDOB: '1949-11-22', fatherCOB: 'China',
  fatherMStatus: '5', fatherAddress: 'Deceased, Dalian, China, 2015-06-03',
  fatherOccupation: 'Retired', fatherAcc: 'N',
};
const DEMO_ROWS = {
  children: [
    { name: 'LIU, Yang', zh: '刘洋', rel: 'Son', dob: '2007-03-19', mstatus: '6', cob: 'China',
      occ: 'Student', addr: 'No. 18 Renmin Road, Zhongshan District, Dalian', acc: 'N' },
  ],
  siblings: [
    { name: 'LIU, Zhihui', zh: '刘志辉', rel: 'Brother', dob: '1974-07-11', mstatus: '5',
      cob: 'China', occ: 'Engineer', addr: 'Shahekou District, Dalian', acc: 'N' },
    { name: 'LIU, Zhimei', zh: '刘志梅', rel: 'Sister', dob: '1980-12-05', mstatus: '3',
      cob: 'China', occ: 'Teacher', addr: 'Heping District, Shenyang', acc: 'N' },
  ],
  // four jobs: IMM5257 has room for three, IMM0104 takes them all
  employment: [
    { from: '2019-10-01', to: '2026-07-15', position: 'Sales Manager',
      employer: 'Dalian Yangli Machinery Co., Ltd.', city: 'Dalian', prov: 'Liaoning', country: '202' },
    { from: '2015-03-01', to: '2019-08-31', position: 'Sales Representative',
      employer: 'Example Trading Pte. Ltd.', city: 'Singapore', prov: '', country: '246' },
    { from: '2010-05-01', to: '2015-02-28', position: 'Technician',
  ...
  education: [
    { from: '2000-09-01', to: '2004-06-30', position: "Bachelor's degree in Mechanical Engineering",
      school: 'Dalian University of Technology', city: 'Dalian', prov: 'Liaoning', country: '202',
      description: 'Full-time' },
  ],
  travel: [
    { from: '2025-03-06', to: '2025-03-14', name: 'Business', description: 'Singapore' },
    { from: '2018-11-02', to: '2018-11-09', name: 'Business', description: 'Kuala Lumpur, Malaysia' },
  ],
};
